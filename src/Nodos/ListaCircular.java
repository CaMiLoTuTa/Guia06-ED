...
public class ListaCircular {
    ...
    /**
     * Inserta un nuevo nodo después de otro, ubicado por el valor que contiene.
     *
    ...
    public void insertarPorReferencia(int referencia, int valor) {
        ...
        if (!esVacia()) {
            ...
            if (buscar(referencia)) {
                ...
                // Consulta si el nodo a insertar va después del ultimo
                if (aux == ultimo) {
                    // Apuntamos con el ultimo nodo de la lista al nuevo.
    ...
    /**
     * Inserta un nuevo nodo después en una posición determinada.
     *
        ...
        while (flag) {
            ...
            for (i = 0; i < tamaño - 1; i++) {
                if (this.getValor(i) > this.getValor(i + 1)) {
                    temp = this.getValor(i);
                    this.editarPorPosicion(i, this.getValor(i + 1));
                    this.editarPorPosicion(i + 1, temp);
                    flag = true;
                }
            }
        }
